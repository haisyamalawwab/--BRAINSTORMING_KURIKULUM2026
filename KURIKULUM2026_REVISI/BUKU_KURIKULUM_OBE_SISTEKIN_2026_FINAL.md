...
> **Standar Rujukan:** Standar Nasional Pendidikan Tinggi (SN-Dikti / Permendikbudristek No. 53 Tahun 2023), Panduan Kurikulum OBE APTIKOM S1 Sistem Informasi v2.0 (IS2020), Panduan Kurikulum OBE APTIKOM S1 Teknologi Informasi (IT2017), ACM/IEEE Computing Curricula 2020 (CC2020).
...
| Sem 6 | Capstone, PKL & Deep Learning | 7 MK | 19 SKS | Deep Learning, Platform Eng, Metopen, Capstone FSTI, PKL, Pra-Skripsi, Peminatan 2 |
| Sem 7 | Inovasi, Smart City & Integrasi AI | 7 MK | 20 SKS | Integrasi AI, Smart City, Startup Digital, Peminatan 3, 4, 5, 6 |
...
| 25 | `STI-415` | Data Warehouse & Business Intelligence | 3 | +P | Core STI | `FST-207` |
| 26 | `STI-416` | Web Back End Development | 3 | +P | Core STI | `FST-207`, `STI-311` |
| 27 | `STI-417` | Komputasi Awan (Cloud Computing) | 3 | Teori | Core STI | `STI-312`, `STI-310` |
| 28 | `STI-418` | Dasar Keamanan Informasi | 2 | Teori | Core STI | `STI-312` |
| 29 | `FST-408` | Probabilitas dan Statistika | 3 | Teori | FSTI | `STI-102` |
| 30 | `STI-414` | Pengantar NLP & Information Retrieval | 2 | +P | Core STI | `STI-307` |
...
| No | Kode MK | Nama Mata Kuliah | SKS | Tipe | Kategori | Prasyarat |
|:---:|:---:|---|:---:|:---:|:---:|---|
| 39 | STI-626 | Deep Learning & Neural Networks | 3 | +P | Core STI | STI-413 |
| 40 | STI-627 | Digital Platform Engineering | 3 | +P | Core STI | STI-416 |
| 41 | FST-610 | Capstone Project FSTI | 3 | Proyek | FSTI | STI-523, $\ge 100\text{ SKS}$ |
| 42 | FST-611 | Metodologi Penelitian | 2 | Teori | FSTI | $\ge 76\text{ SKS}$ |
| 43 | FST-612 | Praktik Kerja Lapangan (PKL) | 3 | Magang | FSTI | $\ge 100\text{ SKS}$ |
| 44 | FST-613 | Pra-Skripsi / Seminar Proposal | 2 | Seminar | FSTI | FST-611, $\ge 100\text{ SKS}$ |
| 45 | STA/B/C | **MK Pilihan Peminatan 2** | 3 | Elektif | Peminatan | Prasyarat Peminatan |
...
> * **Peminatan 2 (Cloud & Cyber):** STB-601 Cloud Architecture & DevOps (+P, 3 SKS, Prasyarat: STI-417)
> * **Peminatan 3 (Platform Eng):** STC-601 Rekayasa & Otomasi Proses Bisnis (+P, 3 SKS, Prasyarat: STI-306)

### SEMESTER 7 (20 SKS)
| No | Kode MK | Nama Mata Kuliah | SKS | Tipe | Kategori | Prasyarat |
|:---:|:---:|---|:---:|:---:|:---:|---|
| 46 | STI-624 | Integrasi Layanan Cerdas Berbasis AI | 3 | +P | Core STI | STI-413, STI-416 |
| 47 | STI-625 | Smart City & Pemerintahan Digital | 2 | Teori | Core STI | STI-521 |
| 48 | STI-728 | Inovasi Teknologi dan Startup Digital | 3 | +P | Core STI | STI-627, MKU-204 |
| 49 | STA/B/C | **MK Pilihan Peminatan 3** | 3 | Elektif | Peminatan | Prasyarat Peminatan |
...
> * **Peminatan 1 (Smart Systems):** STA-602 Intelligent Agent Systems (+P, 3 SKS), STA-701 MLOps and AI Pipeline (+P, 3 SKS), STA-702 Conversational AI and Intelligent Assistant (+P, 3 SKS), STA-703 Smart Surveillance and IoT Analytics (+P, 3 SKS)
...
| (Flagship) |  | 3. STA-602 Intelligent Agent Systems (+P, Sem 7) |
...
| (Volume) |  | 3. STB-602 Cybersecurity Risk Management (Teori, S7) |
...
| (Niche & Techno) |  | 3. STC-602 Rekayasa Aplikasi Industri Vertikal(+P,S7 |
...
| 2 | `STA-601` | Rekayasa Big Data dan Komputasi Terdistribusi | 3 | +P | Sem 6 | `FST-207`, `STI-415` Data Warehouse & BI | BK-IS02 / BK-IS18 Data & ML Terdistribusi |
| 3 | `STA-602` | Intelligent Agent Systems | 3 | +P | Sem 7 | `STI-307` Sistem Cerdas | BK-IT02 Multi-Agent Systems, Reinforcement |
...
| 3 | `STB-602` | Cybersecurity Risk Management | 3 | Teori | Sem 7 | `STI-418` Dasar Keamanan Informasi | BK-IS06 Risk Management, ISO 27005, NIST |
...
| 3 | `STC-602` | Rekayasa Aplikasi Industri Vertikal (FinTech & EdTech) | 3 | +P | Sem 7 | `STI-416` Web Back End Development | BK-IS05 Application Domains, Microservices |
...
| Bersertifikat (MSIB) |  | • STI-626 Deep Learning (3) |  |
...
### BAGIAN A: Identitas & Keselarasan Okupasi (4 PL)
1. **Posisi/Jabatan Pekerjaan Saat Ini:**
   * [ ] *AI / Data / Machine Learning Engineer* (Selaras **PL-1**)
   * [ ] *Cloud / Cybersecurity / Smart Systems Integrator* (Selaras **PL-2**)
   * [ ] *UI/UX Designer / Digital Platform Engineer* (Selaras **PL-3**)
   * [ ] *Tech Startup Founder / IT Product Manager* (Selaras **PL-4**)
   * [ ] Lainnya: _______________
2. **Kesesuaian Bidang Kerja dengan Keilmuan SISTEKIN:**
   * [ ] Sangat Erat (Skor 5) | [ ] Erat (Skor 4) | [ ] Cukup (Skor 3) | [ ] Kurang (Skor 2) | [ ] Tidak Erat (Skor 1)
3. **Waktu Tunggu Mendapatkan Pekerjaan Pertama:**
...
| **PEO-1** | 3. Mampu memimpin (*leadership*) atau berkontribusi aktif dalam tim rekayasa multidisiplin. | `[ 1 ] [ 2 ] [ 3 ] [ 4 ] [ 5 ]` |
...
| **PEO-2** | 5. Menginisiasi/mengembangkan usaha rintisan (*startup*) digital atau berperan aktif sebagai *product owner*. | `[ 1 ] [ 2 ] [ 3 ] [ 4 ] [ 5 ]` |
...
| **PEO-3** | 8. Terus memutakhirkan keahlian keilmuan secara mandiri sepanjang hayat (*lifelong learning*). | `[ 1 ] [ 2 ] [ 3 ] [ 4 ] [ 5 ]` |
...
| 5 | **Kerja Sama Tim & Kepemimpinan (*Team Leadership*)** | `[ 1: Sangat Kurang ] [ 2 ] [ 3: Cukup ] [ 4 ] [ 5: Sangat Baik ]` |
...
| Level Status | Definisi Operasional | Kondisi SISTEKIN 2026 |
|:---:|---|:---:|
...
---
*Disahkan sebagai Dokumen Resmi 010 — Kurikulum OBE Revisi SISTEKIN 2026.*  
**Tim Pengembang Kurikulum FSTI Universitas Widyagama Malang**
...
3. **Rasio Dosen-Mahasiswa:** Menjaga rasio ideal $\le 1 : 25$ untuk menjamin efektivitas pendampingan *Project-Based Learning* dan *Capstone Project*.

---

## 8.2 Sarana Laboratorium dan Komputasi Cerdas
Untuk mendukung pelaksanaan kurikulum berbasis praktik dan integrasi AI nyata, FSTI menyediakan 4 laboratorium terintegrasi:
1. **Intelligent Systems & Data Engineering Lab:** Dilengkapi workstation GPU berkecepatan tinggi untuk pelatihan model *Deep Learning*, *Machine Learning*, dan *Big Data Processing*.
2. **Cloud Infrastructure & Cybersecurity Cyber-Range Lab:** Dilengkapi server rak terisolasi, virtualisasi lingkungan *Cloud Native (Docker/Kubernetes)*, dan perangkat simulasi pertahanan siber.
3. **IoT, Smart Devices & Hardware Integration Lab:** Dilengkapi mikrokontroler (ESP32, Raspberry Pi, sensor telemetri industri MQTT, kit aktuator cerdas).
4. **Digital Platform & UI/UX Usability Testing Lab:** Dilengkapi perangkat pengujian antarmuka multi-layar, software prototyping industri (Figma Enterprise), dan perekam interaksi pengguna.
...
|:---:|---|:---:|:---:|---|:---:|---|
| `FST-101` | Dasar Teknologi Digital | 2 | `FST-101` | Dasar Teknologi Digital | 2 | Ekuivalen Penuh |
| `FST-102` | Algoritma & Pemrograman | 3 | `FST-102` | Algoritma & Pemrograman | 3 | Ekuivalen Penuh |
| `STI-101` | Pengantar Sistem & TI | 2 | `STI-101` | Pengantar Sistem & TI | 2 | Ekuivalen Penuh |
| `STI-102` | Kalkulus | 3 | `STI-102` | Kalkulus | 3 | Ekuivalen Penuh |
| `STI-103` | Logika Informatika (Lama) | 3 | `STI-103` | Arsitektur & Organisasi Sistem TI | 3 | Ekuivalen / Penyesuaian Topik |
| `STI-204` | Matematika Diskrit (Lama) | 3 | `STI-204` | Matematika Diskrit dan Logika | 3 | Ekuivalen Penuh (Integrasi Logika) |
| `STI-205` | Aljabar Linier & Matriks | 3 | `STI-205` | Aljabar Linear & Matriks | 3 | Ekuivalen Penuh |
| `FST-203` | Struktur Data & Algoritma | 3 | `FST-203` | Struktur Data & Algoritma | 3 | Ekuivalen Penuh |
| `FST-204` | Organisasi & Arsitektur Komputer | 2 | `FST-204` | Organisasi & Arsitektur Komputer | 2 | Ekuivalen Penuh |
| `FST-205` | Pemrograman Lanjut | 2 | `FST-205` | Pemrograman Lanjut (OOP) | 2 | Ekuivalen Penuh |
| `FST-207` | Sistem Basis Data | 3 | `FST-207` | Sistem Basis Data | 3 | Ekuivalen Penuh |
| `STI-310` | Sistem Operasi | 3 | `STI-310` | Sistem Operasi (Digeser ke Sem 3) | 3 | Ekuivalen Penuh |
| `STI-312` | Jaringan Komputer | 3 | `STI-312` | Jaringan Komputer (Digeser ke Sem 3) | 3 | Ekuivalen Penuh |
| `STI-417` | Komputasi Awan (Cloud) | 3 | `STI-417` | Komputasi Awan (Cloud) | 3 | Ekuivalen Penuh |
| `STI-418` | Keamanan Informasi Dasar | 2 | `STI-418` | Dasar Keamanan Informasi | 2 | Ekuivalen Penuh |
...
| `STI-624` | AI Terapan & Layanan Cerdas | 3 | `STI-624` | Integrasi Layanan Cerdas AI (Sem 7) | 3 | Ekuivalen Penuh |
| `FST-610` | Capstone Project FSTI | 3 | `FST-610` | Capstone Project FSTI (Sem 6) | 3 | Ekuivalen Penuh |
...
|---|---|---|---|
| **Pilar 1: AI & Smart Systems Integration** | **PEO-1:** *Professional Practice & Systems Integration*<br>**PEO-3:** *Advanced Study, Research & Lifelong Learning* | **PL-1:** *Intelligent Information Systems & Data/AI Engineer*<br>**PL-2:** *Cloud Infrastructure, Cybersecurity & Smart Systems Integrator* | AI Engineer, ML Engineer, Data Scientist, IoT Specialist, Cloud Architect, Cybersecurity Specialist, Peneliti AI. |
| **Pilar 2: Modern Digital Platform & Software Engineering** | **PEO-1:** *Professional Practice & Systems Integration*<br>**PEO-2:** *Digital Innovation & Technopreneurship* | **PL-3:** *UI/UX Designer & Digital Platform Engineer* | Full-Stack Platform Engineer, Microservices Specialist, UI/UX Lead, Mobile App Developer, Solution Architect. |
| **Pilar 3: Technopreneurship & Kemandirian Bangsa** | **PEO-2:** *Digital Innovation & Technopreneurship*<br>**PEO-1:** *Professional Practice & Systems Integration* | **PL-4:** *Digital Technopreneur & IT Product Innovator* | Tech Startup Founder, IT Project Manager, Chief Product Officer (CPO), IT Business Strategist, Digital Consultant. |
...
| 9 | `STI-204` | Matematika Diskrit & Logika | 3 | | **I** | | | **I** | | | | | | | | | | PL-1, PL-2 | PEO-1, PEO-3 | **I** |
| 10 | `STI-205` | Aljabar Linear & Matriks | 3 | | | | | **I** | | | | | | | | | | PL-1, PL-2 | PEO-1, PEO-3 | **I** |
...
| 19 | `STI-308` | UI/UX Design & Prototyping | 3 | | | | | | | | | | | | | **R** | | PL-3 | PEO-1, PEO-2 | **R** |
| 20 | `STI-309` | Rekayasa Perangkat Lunak | 3 | | | | | | | | **R** | | | | | **R** | | PL-1, PL-3 | PEO-1 | **R** |
| 21 | `STI-310` | Sistem Operasi | 3 | | | | | | | **R** | | | | **R** | | | | PL-2 | PEO-1 | **R** |
| 22 | `STI-311` | Web Front End Development | 3 | | | | | | | | **R** | | | | | **R** | | PL-3 | PEO-1, PEO-2 | **R** |
| 23 | `STI-312` | Jaringan Komputer | 3 | | | | | | | **R** | | | | **R** | | | | PL-2 | PEO-1 | **R** |
| 24 | `STI-413` | Machine Learning | 3 | | | | | | **R** | | | **R** | | | | | | PL-1 | PEO-1, PEO-3 | **R** |
| 25 | `STI-415` | Data Warehouse & BI | 3 | | | | | | **R** | | | | **R** | | | | | PL-1 | PEO-1 | **R** |
| 26 | `STI-416` | Web Back End Development | 3 | | | | | | | | **R** | | | | | **R** | | PL-3 | PEO-1, PEO-2 | **R** |
| 27 | `STI-417` | Komputasi Awan (Cloud) | 3 | | | | | | | **R** | | | | **R** | | | | PL-2 | PEO-1 | **R** |
| 28 | `STI-418` | Dasar Keamanan Informasi | 2 | | | | | | | **R** | | | | **R** | | | | PL-2 | PEO-1 | **R** |
| 29 | `FST-408` | Probabilitas & Statistika | 3 | | | | | **R** | | | | | | | | | | PL-1, PL-2 | PEO-1, PEO-3 | **R** |
| 30 | `STI-414` | Pengantar NLP & IR | 2 | | | | | | **R** | | | **R** | | | | | | PL-1 | PEO-1, PEO-3 | **R** |
...
| 36 | `STI-523` | Manajemen Proyek TI | 3 | | | | | | | | | | | | | | **R** | PL-4 | PEO-1, PEO-2 | **R** |
...
| 53 | `FST-714` | Skripsi / Tugas Akhir | 6 | **M** | **M** | **M** | **M** | **M** | **M** | **M** | **M** | **M** | **M** | **M** | **M** | **M** | **M** | Seluruh PL | PEO-1, PEO-2, PEO-3 | **M** |
...
* **Syarat Mutu IKU 7:** Bobot Evaluasi Kolaboratif $(CM + PjBL) \ge 50\%$.

| No | Kode MK | Nama Mata Kuliah | SKS | Bobot Case Method (%) | Bobot Team-Based PjBL (%) | Bobot Evaluasi Kognitif / Lab (%) | **Total Bobot IKU 7 (CM + PjBL)** | Status Kepatuhan IKU 7 |
|:---:|:---:|---|:---:|:---:|:---:|:---:|:---:|:---:|
| 1 | `FST-101` | Dasar Teknologi Digital | 2 | 20% | 30% | 50% | **50%** | ✅ Patuh IKU 7 |
...
| 9 | `STI-204` | Matematika Diskrit & Logika | 3 | 20% | 0% | 80% | 20% | *MK Teori Dasar Sains* |
| 10 | `STI-205` | Aljabar Linear & Matriks | 3 | 20% | 0% | 80% | 20% | *MK Teori Dasar Sains* |
...
| 17 | `STI-306` | Analisis & Perancangan SI | 3 | 30% | 40% | 30% | **70%** | ✅ Patuh IKU 7 |
| 18 | `STI-307` | Sistem Cerdas | 2 | 25% | 35% | 40% | **60%** | ✅ Patuh IKU 7 |
| 19 | `STI-308` | UI/UX Design & Prototyping | 3 | 20% | 55% | 25% | **75%** | ✅ Patuh IKU 7 |
| 20 | `STI-309` | Rekayasa Perangkat Lunak | 3 | 20% | 55% | 25% | **75%** | ✅ Patuh IKU 7 |
| 21 | `STI-310` | Sistem Operasi | 3 | 20% | 35% | 45% | **55%** | ✅ Patuh IKU 7 |
| 22 | `STI-311` | Web Front End Development | 3 | 20% | 50% | 30% | **70%** | ✅ Patuh IKU 7 |
| 23 | `STI-312` | Jaringan Komputer | 3 | 20% | 35% | 45% | **55%** | ✅ Patuh IKU 7 |
| 24 | `STI-413` | Machine Learning | 3 | 20% | 50% | 30% | **70%** | ✅ Patuh IKU 7 |
| 25 | `STI-415` | Data Warehouse & BI | 3 | 25% | 45% | 30% | **70%** | ✅ Patuh IKU 7 |
| 26 | `STI-416` | Web Back End Development | 3 | 20% | 50% | 30% | **70%** | ✅ Patuh IKU 7 |
| 27 | `STI-417` | Komputasi Awan (Cloud) | 3 | 20% | 45% | 35% | **65%** | ✅ Patuh IKU 7 |
| 28 | `STI-418` | Dasar Keamanan Informasi | 2 | 25% | 30% | 45% | **55%** | ✅ Patuh IKU 7 |
...
| 36 | `STI-523` | Manajemen Proyek TI | 3 | 30% | 45% | 25% | **75%** | ✅ Patuh IKU 7 |
...
| 46 | `STI-728` | Inovasi & Startup Digital | 3 | 20% | 60% | 20% | **80%** | ✅ Patuh IKU 7 |
| 47 | `FST-610` | Capstone Project FSTI | 3 | 0% | 85% | 15% | **85%** | ✅ Patuh IKU 7 |
| 48 | `FST-612` | Praktik Kerja Lapangan(PKL)| 3 | 0% | 85% | 15% | **85%** | ✅ Patuh IKU 7 |
| 49 | `FST-613` | Pra-Skripsi / Sempro | 2 | 30% | 50% | 20% | **80%** | ✅ Patuh IKU 7 |
| 50 | `STA/B/C` | MK Pilihan Peminatan 4 | 3 | 20% | 50% | 30% | **70%** | ✅ Patuh IKU 7 |
| 51 | `STA/B/C` | MK Pilihan Peminatan 5 | 3 | 20% | 50% | 30% | **70%** | ✅ Patuh IKU 7 |
| 52 | `STA/B/C` | MK Pilihan Peminatan 6 | 3 | 20% | 50% | 30% | **70%** | ✅ Patuh IKU 7 |
| 53 | `FST-714` | Skripsi / Tugas Akhir | 6 | 0% | 90% | 10% | **90%** | ✅ Patuh IKU 7 |

> **Rekapitulasi Kepatuhan IKU 7 Kurikulum SISTEKIN 2026:**  
> * **Persentase MK Memenuhi IKU 7 (CM + PjBL $\ge 50\%$):** **89.1%** (49 dari 55 MK paket).  
...
Dokumen matriks keterlacakan ini membuktikan secara definitif bahwa kurikulum SISTEKIN 2026:
1. **Memiliki Keselarasan Konstruktif Utuh:** Tidak ada pemisahan (*disconnect*) antara visi institusi dengan mata kuliah yang diajarkan setiap minggunya.
2. **Keseimbangan Bobot SKS:** Seluruh 14 CPL terlayani secara adil dan proporsional dengan alokasi SKS yang solid.
3. **Kepatuhan Instrumen Akreditasi:** Format matriks memenuhi 100% instrumen akreditasi LAM INFOKOM Kriteria 6 dan standar IABEE Kriteria 1-3.
...
# LAMPIRAN 2: MASTER PORTOFOLIO SILABUS 3-TABEL LENGKAP 67 MATA KULIAH
